...
# %% auto 0
__all__ = ['X', 'rejection_sample_for_torus', 'torus', 'rejection_sample_for_hyperboloid', 'hyperboloid',
...
# %% ../nbs/2 Datasets.ipynb 37
from tadasets import dsphere
X = dsphere(n=1000, d=2)

# %% ../nbs/2 Datasets.ipynb 44
